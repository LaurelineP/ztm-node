...
/* Emits `ballMove` event handler */
function emitBallMove () {
  isReferee && socket.emit('ballMove', { ballX, ballY , score });
}
...
function animate() {
  // computerAI();
  /* Only referees update for everyone */
  if(isReferee){
    ballMove();
    ballBoundaries();
  }
...
function startGame(isReferee) {
  ...
  canvas.addEventListener('mousemove', (e) => {
    ...
    // Let the server know the paddle as moved to broadcast and synced paddles in every clients
